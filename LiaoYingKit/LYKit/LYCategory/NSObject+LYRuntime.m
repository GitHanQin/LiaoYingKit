...
{
    return [[self class] ly_propertiesInfo];
}
...
+ (NSArray *)ly_propertiesInfo
{
    ...
    for (int i = 0; i < propertyCount; i++)
    {
        [propertieArray addObject:({
            ...
            NSDictionary *dictionary = [self ly_dictionaryWithProperty:properties[i]];
...
+ (NSArray *)ly_propertiesWithCodeFormat
{
    ...
    NSArray *properties = [[self class] ly_propertiesInfo];
...
{
    return [[self class] ly_protocolList];
}
