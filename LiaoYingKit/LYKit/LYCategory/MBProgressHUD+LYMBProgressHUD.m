//
//  MBProgressHUD+LYMBProgressHUD.m
//  PersonalOC
//
...
#import "MBProgressHUD+LYMBProgressHUD.h"
#import "Define_UI.h"

@implementation MBProgressHUD(LYMBProgressHUD)
/**
 *  =======显示信息
 *  @param text 信息内容
 *  @param icon 图标
...
+ (void)show:(NSString *)text icon:(NSString *)icon view:(UIView *)view
{
    ...
    hud.label.textColor = LY_HEX_RGB(0x333333);
