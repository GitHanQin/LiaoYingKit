//
//  UINavigationController+LYNavgationController.m
//  LYKitDemo
//
...
#import "UINavigationController+LYNavgationController.h"

@implementation UINavigationController (LYNavgationController)
...
{
    return [self popToViewController:[self ly_findViewController:className] animated:YES];
}
