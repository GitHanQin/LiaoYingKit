...
+ (instancetype)ly_colorWithHex:(uint32_t)hex {
    ...
    return [self ly_colorWithRed:r green:g blue:b];
}

+ (instancetype)ly_randomColor {
    return [UIColor ly_colorWithRed:arc4random_uniform(256) green:arc4random_uniform(256) blue:arc4random_uniform(256)];
}
...
+ (UIColor*)ly_gradientFromColor:(UIColor*)c1 toColor:(UIColor*)c2 withHeight:(CGFloat)height
{
